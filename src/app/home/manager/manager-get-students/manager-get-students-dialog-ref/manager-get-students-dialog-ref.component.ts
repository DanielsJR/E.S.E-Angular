...
@Component({
  selector: 'nx-manager-get-students-dialog-ref',
  templateUrl: './manager-get-students-dialog-ref.component.html',
  styleUrls: ['./manager-get-students-dialog-ref.component.css']
})
export class ManagerGetStudentsDialogRefComponent implements OnInit {
 ...
 // objs: User[] = [];
  ...
  constructor(
      public dialogRef: MatDialogRef<ManagerGetStudentsDialogRefComponent>,
      @Inject(MAT_DIALOG_DATA) public data: any,
      private userStoreservice: ManagerGetStudentsStoreService, private formBuilder: FormBuilder
  ) {
      this.obj = data.obj;
    }
